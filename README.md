...
The site uses GitHub API. For certian pages to work correctly, you need to set the `GITHUB_TOKEN` environment value to a [GitHub Personal Access Token](https://github.com/settings/tokens) (no scopes needed).
