...
def test_get_involved_cs_renders_special_labels(
    github, test_client, label_name, label_text
):
    """
...
def test_get_involved_cs_renders_repo_name(
    github, test_client, repo_name, is_rendered, label_cls
):
    """
...
def test_get_involved_cs_pull_request_icon(
    github, test_client, is_pull_request, icon_name
):
    """
...
def test_talks_pdf_download(test_client):
    response = test_client.get("/talks/brno-2013-11-28-veros-kaplan-postgis.pdf")
